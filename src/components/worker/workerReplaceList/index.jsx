...
const StyledTableCell = styled(TableCell)(({ theme }) => ({
  ...
  function createData(name, calories, fat, carbs,cost, component) {
    return { name, calories, fat, carbs,cost, component };
  }
  
  const rows = [
    createData("Frozen yoghurt", 159, 6.0, 24, 4.0, 'Baterry'),
  ];

export default function WorkerReplaceList() {
  ...
  // if(phones !== []){
  //   const newPhone = phones.filter(el => el.option === 'Baterry' || el.status === true)
  // }
